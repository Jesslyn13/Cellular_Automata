...
public interface AlgorithmDefaults {
    ...
    AlgorithmSettings LANGTONS_ANT_SETTINGS = new AlgorithmSettings(1, 2, new double[]{0.5, 0.5});
    AlgorithmSettings FLOOD_SETTINGS = new AlgorithmSettings(2, 0, new double[]{0.1, 0.9});
